...
const CATEGORIES = ['Color Palette', 'Outfits', 'Decor', 'Flowers', 'Food', 'Jewellery', 'Other'];
...
export default function MoodBoard() {
  ...
  function openNew() { setForm(BLANK); setFile(null); setShowModal(true); }
  ...
  async function save() {
    ...
    try {
      ...
      if (file) {
        ...
        payload = { imageUrl: form.imageUrl.trim(), caption: form.caption, category: form.category };
      }
    ...
    <div className="page-fade">
      ...
      {filtered.length === 0 ? (
        <div className="empty-state" style={{ padding: '40px 0' }}>
          ...
          <div className="empty-desc">Add images from your phone or the web to collect inspiration.</div>
        </div>
      ) : (
